...
namespace Physics
{
    ...
    void System::init(Core::EventManager &em)
    {
        _environment = new PhysicsEnvironment;
    ...
    void System::update(Core::EventManager &em)
    {
        handleEvents();
    ...
    void System::stop(Core::EventManager &em)
    {
        delete _environment;
    }
    ...
    void System::onEvent(std::shared_ptr<const Core::Event> e)
    {
        switch (e->getType())
        {
    ...
    void System::onCreateEntity(const Core::CreateEntityEvent *e)
    {
    ...
    void System::onUnloadEntity(const Core::UnloadEntityEvent *e)
    {
    ...
    void System::onTransformEntity(const Core::TransformEntityEvent *e)
    {
    ...
    void System::onTransformEntities(const Core::TransformEntitiesEvent *e)
    {
    ...
    void System::onAddRigidbodyComponent(const Core::AddRigidbodyComponentEvent *e)
    {
        if (haveEntity(e->entity)) {
        ...
        Rigidbody *rb = _environment->createRigidbody();
    ...
    bool System::haveEntity(unsigned int ent) const
    {
    ...
    System::PEnt::PEnt(unsigned int EntityID, unsigned int ComponentID) :
        entityID(EntityID), componentID(ComponentID), rigidbody(nullptr)
    {}


    System::PEnt::PEnt(const PEnt &p) :
    ...
    void System::PEnt::updateTransformFromRigidbody()
    {
