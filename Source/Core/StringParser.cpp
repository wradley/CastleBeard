...
std::vector<std::string> Core::StringParser::Split(
...
std::vector<std::string> Core::StringParser::Split(const std::string & s, char c)
{
    std::vector<std::string> strs;
    std::size_t first(0), last(0);
...
std::string Core::StringParser::Trim(const std::string & s)
{
