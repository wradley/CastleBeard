...
#include "../../Include/Core/StringParser.h"
#include "../../Include/Debug.h"


Core::PrefFile::PrefFile()
{
}
...
bool Core::PrefFile::loadFile(const std::string & filepath)
{
...
int Core::PrefFile::getInt(const std::string & key) const
{
...
float Core::PrefFile::getFloat(const std::string & key) const
{
...
std::string Core::PrefFile::getString(const std::string & key) const
{
