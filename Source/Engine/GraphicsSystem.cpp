...
namespace Engine
{
    ...
    void GraphicsSystem::init(Core::EventManager & em)
    {
    ...
    void GraphicsSystem::update(Core::EventManager & em)
    {
        handleEvents();
        _renderer->draw();
    }
    ...
    void GraphicsSystem::stop(Core::EventManager & em)
    {
        handleEvents();
    }
    ...
    void GraphicsSystem::onEvent(std::shared_ptr<const Core::Event> e)
    {
        switch (e->getType())
        {
    ...
    void GraphicsSystem::onCreateEntity(const Core::CreateEntityEvent * e)
    {
        if (!e) {
    ...
    void GraphicsSystem::onUnloadEntity(const Core::UnloadEntityEvent * e)
    {
        if (!e) {
            DEBUG_LOG("Given null event");
            return;
    ...
    void GraphicsSystem::onAddModel(const Core::AddModelComponentEvent * e)
    {
        if (!e) {
            DEBUG_LOG("Given null event");
            return;
    ...
    void GraphicsSystem::onAddCamera(const Core::AddCameraComponentEvent * e)
    {
        if (!e) {
            DEBUG_LOG("Given null event");
            return;
    ...
    void GraphicsSystem::onModCamera(const Core::ModCameraComponentEvent * e)
    {
        if (!e) {
            DEBUG_LOG("Given null event");
            return;
    ...
    void GraphicsSystem::onTransformEntity(const Core::TransformEntityEvent *e)
    {
        if (!e) {
            DEBUG_LOG("Given null event");
            return;
    ...
    void GraphicsSystem::onTransformEntities(const Core::TransformEntitiesEvent *e)
    {
        if (!e) {
            DEBUG_LOG("Given null event");
            return;
    ...
    void GraphicsSystem::onResizeWindow(const Core::ResizeWindowEvent * e)
    {
        if (!e) {
            DEBUG_LOG("Given null event");
            return;
