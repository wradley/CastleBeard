...
namespace Engine
{
    ...
    void PlayerControllerSystem::init(Core::EventManager & em)
    {
    ...
    void PlayerControllerSystem::update(Core::EventManager & em)
    {
        handleEvents(em);
    }


    void PlayerControllerSystem::stop(Core::EventManager & em)
    {
        handleEvents(em);
    }


    void PlayerControllerSystem::handleEvents(Core::EventManager & em)
    {
    ...
    void PlayerControllerSystem::onCreateEntity(const Core::CreateEntityEvent * e)
    {
        if (!e) {
    ...
    void PlayerControllerSystem::onUnloadEntity(const Core::UnloadEntityEvent * e)
    {
        if (!e) {
            DEBUG_LOG("Null event");
            return;
    ...
    void PlayerControllerSystem::onControllerInput(const Core::ControllerInputEvent *e, Core::EventManager &em)
    {
        if (!e) {
            DEBUG_LOG("Null event");
            return;
    ...
    void PlayerControllerSystem::onTransformEntity(const Core::TransformEntityEvent *e)
    {
        if (!e) {
            DEBUG_LOG("Null event");
            return;
    ...
    void PlayerControllerSystem::onTransformEntities(const Core::TransformEntitiesEvent *e)
    {
        if (!e) {
            DEBUG_LOG("Null event");
            return;
    ...
    void PlayerControllerSystem::onAddPlayerControllerComponent(const Core::AddPlayerControllerComponentEvent *e)
    {
        if (!e) {
            DEBUG_LOG("Null event");
            return;
