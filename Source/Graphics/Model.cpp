...
Graphics::Model::Model(Renderer *renderer, Scene *parent) :
...
void Graphics::Model::loadFile(const std::string & filepath)
{
    // load model file
...
void Graphics::Model::draw(const Math::Mat4 &proj, const Math::Mat4 &view)
{
    _shader->bind();
